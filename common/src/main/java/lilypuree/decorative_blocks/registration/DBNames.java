...
public class DBNames {
    ...
    public static Identifier FLOWING_THATCH = create("flowing_thatch");
    public static Identifier STILL_THATCH = create("thatch");

    protected static Identifier create(String name) {
